...
<p>We are excited to embark on this journey and share it with you as we grow and learn. We hope to be as inspirational to you as others have been to us. And, most importantly, thank you for taking the time to get to know us!</p>
        ...
        <p>After being together for two years, we decided to change careers and move into the tech industry as web developers.  Partially because we feel that the webdev industry is growing, and partially because we wanted the geographic freedom of a job they could work remotely.  The conversation of where to move to quickly evolved into a plan to live on a boat full time.  Shortly after this plan was fleshed out and the steps were taken to begin the career transition, Covid hit and we took the time to reevaluate this plan as many full time cruisers were adversely affected by the lockdowns.  While the pandemic was most likely a once in a lifetime event, the need for a home port to return to was glaringly obvious to us.  The plan shifted from full time on the boat to winters in the Bahamas aboard with the hurricane season spent in a house somewhere in North Carolina.</p></h2>
        
        <p><h4>That's where we are today.  We hope you enjoy what we have here so far and stick around as the plan unfolds and our adventures begin.  --J&C</h4></p>
        </div>
    );
}